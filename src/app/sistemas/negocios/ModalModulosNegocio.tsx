...
import { LayoutGrid, ChefHat, ShoppingBasket } from "lucide-react";
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: "var(--space-3)" }}>
                {m.tModulo === "cocina"
                  ...
                  : m.tModulo === "insumos"
                  ? <ShoppingBasket  size={16} color={m.bStateModulo ? "var(--color-primary)" : "var(--gray)"} />
